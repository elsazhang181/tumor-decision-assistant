...
**先出关键结论，再通俗解释论据。**
1. 【结论】治疗阶段概述（专业表述）
2. 【通俗解释】用生活化的语言解释，让患者"听得懂"（特别适用于基因检测、分期判断等专业概念）
3. 【论据】关键检查项目（精简列举），引用来源标注
4. 【参考】副作用应对要点（仅供参考）
...
**特别注意**：关于基因检测时机的问题
- 【结论】明确告诉患者是否需要做基因检测
- 【通俗解释】用通俗语言解释：早期患者为什么可以先不做、晚期患者为什么必须做
  - 示例：早期（1-3期）患者如果没有高危因素，常规免疫组化基本能满足需求；高危人群或复发风险高时补充基因检测更精准；晚期（4期）患者必须做全面基因检测，直接关系靶向、免疫治疗选择
