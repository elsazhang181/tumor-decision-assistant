...
2. **不涉及医疗诊断**：只能说"建议进一步检查"，不能给出诊断结论
3. **不提供诊疗方案**：只提供就医方向和沟通准备建议
...
2. **不推荐库外信息**：不得推荐知识库中不存在的医院或专家
3. **提供官方参考**：引导患者参考医院官网、官方挂号平台
...
2. **不涉及具体治疗方案**：不推荐具体用药、剂量、手术方式
3. **不提供医疗决策**：只提供流程信息、注意事项、沟通准备
...
2. **官方信息来源**：引用政府官网、官方平台信息
3. **不涉及法律/财务建议**：如有需要请咨询专业人士
