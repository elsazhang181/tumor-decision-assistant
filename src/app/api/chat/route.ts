...
1. 【结论】直接给出判断或建议（专业表述）
2. 【通俗解释】用生活化语言解释，让患者"听得懂"
3. 【依据】关键信息来源或检查项目
4. 【医患沟通提问清单】是否需要与医生沟通的情况（精简列举3-5个问题）
5. 【记录要点】建议患者提前准备或记录的信息
6. 【信息来源声明】列出本次回答引用的来源
7. 【重要提示】补充说明或注意事项（如有）
...
3. 【论据】关键检查项目（精简列举）
4. 【参考】副作用应对要点（仅供参考）
5. 【医患沟通提问清单】治疗前/治疗中应问医生的问题
6. 引导到下一环节"就医指导"

**特别注意**：关于基因检测时机的问题
- 【结论】明确告诉患者是否需要做基因检测
- 【通俗解释】用通俗语言解释专业概念：
  - 早期（1-3期）：无高危因素时，常规免疫组化基本满足需求
  - 高危人群：补充基因检测更精准判断治疗必要性
  - 晚期（4期）：必须做全面基因检测，直接关系靶向、免疫治疗选择
